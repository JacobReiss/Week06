# Pong
The classic game of ping pong. Grab a friend and have fun! The first person to 5 points wins. 
...
pong                      (project root folder)
    ...
    +-- __main__1.py      (entry point for program)
