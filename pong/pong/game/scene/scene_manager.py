...
class SceneManager:
    ...
    def _add_rackets(self, collection):
        ...
        x = (CENTER_X / 3) - (RACKET_WIDTH / 3)
        y = CENTER_Y - RACKET_HEIGHT/3
        position = Point(x, y)
        ...
        position_b = Point(CENTER_X + x + x, y)
